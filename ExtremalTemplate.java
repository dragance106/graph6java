...
public class ExtremalTemplate {
    ...
    // Other required variables may be declared here:
     ...
     *  while extnum is the number of extremal values of the invariant to be found (1 or more).
     */
    public void run(String inputFileName, int extnum) throws IOException {
        ...
        while ((g6code = in.readLine())!=null) {     // loading g6 codes until an empty line is found
            ...
            if (map.size()<extnum)             // If we still haven't seen at least extnum keys
                ...
                if (map.containsEqualKeys(key)) {  // If the key is already in the map
                    ...
                    // For MIN key, uncomment this and comment the other:
                    ...
                    // For MAX key, uncomment this and comment the other:
